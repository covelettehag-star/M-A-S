...
```
        <div className="relative mx-auto flex max-w-3xl flex-col items-center gap-6">
          ...
          <p className="text-pretty text-base leading-relaxed text-cream-300/80 sm:text-lg">
            Try the AI demo below, then book a free AI audit when you are
            ready to discuss how automation can help your business get more
            leads, respond faster, and save time.
          </p>
