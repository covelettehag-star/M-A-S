...
return ( <header className="fixed inset-x-0 top-0 z-50 flex justify-center px-4 pt-4">
<div
...
> <Link href="/" className="flex items-center" aria-label="MirthLuxe AI Studio home"> <Logo /> </Link>
...
```
    ...
    <div className="hidden lg:block">
      <Link href={bookingUrl} className="btn-gold">
